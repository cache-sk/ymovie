namespace ymovie.web {
	export namespace type {
		export import Media = ymovie.type.Media;
		export import Catalogue = ymovie.type.Catalogue;
	}
	...
	export namespace view {
		export import Component = ymovie.view.Component;
		export import DataComponent = ymovie.view.DataComponent;
	}
}
