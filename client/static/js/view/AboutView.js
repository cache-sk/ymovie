class AboutView extends Dialogue {
	constructor(){
		super(true);
	}
...
<ul>
	<li class="kodi">Kodi - preferred option, compatible with all available streams.</li>
	<li class="vlc">VLC - compatible with most available streams.</li>
...
<h2>Known Issues</h2>
<ul>
	<li>PWA (installed app) is displayed with address bar (not fullscreen) in order to overcome bug in <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=1088090" target="_blank">chrome related to intent: urls</a>.</li>
